...
- 最新决策：`2026-08-20-web-remove-top-navbar.md`（移除顶部导航栏 → 功能下沉页面内 + UI 态收敛 useState）、`2026-08-18-ai-pagination-front-anchor.md`（懒加载分页游标 → 稳定前端边界 anchor）、`2026-08-08-production-cn-entry.md`（生产公网入口 → api.hcyj.xyz/serenique）、`2026-08-08-mcp-sunset.md`（见 `decisions/`，按日期倒序）
