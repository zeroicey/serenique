...
import { logger as pinoLogger, isDevelopment, c } from "@/shared/logger";
...
function colorMethod(method: string): string {
  ...
  switch (method.toUpperCase()) {
    case "GET":     return c.green(padded);
    case "POST":    return c.cyan(padded);
    case "PUT":     return c.yellow(padded);
    case "PATCH":   return c.magenta(padded);
    case "DELETE":  return c.red(padded);
